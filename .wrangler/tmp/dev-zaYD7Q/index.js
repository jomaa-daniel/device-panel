...
var Logger = class {
  ...
  static async writeLog(data, device) {
    console.log(
      JSON.stringify({
        ...data,
...
// src/models/GoveeInterface.ts
var api_key = env.GOVEE_API_KEY;

// src/models/GoveeLight.ts
var GoveeLight = class extends Light {
  static {
    __name(this, "GoveeLight");
  }
  sku;
  device;
  deviceName;
  constructor(sku, device, deviceName) {
    super();
    this.device = device;
    this.sku = sku;
  ...
  async on() {
    const payload = {
      ...
      device: this.device,
      capability: {
        type: "devices.capabilities.on_off" /* ON_OFF */,
  ...
  async setBrightness(brightness) {
    const payload = {
      ...
      device: this.device,
      capability: {
        type: "devices.capabilities.range" /* RANGE */,
        instance: "brightness",
        value: brightness
      }
    };
...
// src/groups/LivingRoom.ts
var getGoveeLights = /* @__PURE__ */ __name(() => {
  return [
...
var LivingRoom = class extends Light {
  static {
    __name(this, "LivingRoom");
  }
  async on() {
...
// src/index.ts
var router = n();
var living_room = new LivingRoom();
...
router.get("/setLivingRoomBrightness25", async () => {
  try {
    await living_room.setBrightness(25 /* B25 */);
...
router.get("/setLivingRoomBrightness50", async () => {
  try {
    await living_room.setBrightness(50 /* B50 */);
...
router.get("/setLivingRoomBrightness75", async () => {
  try {
    await living_room.setBrightness(75 /* B75 */);
...
router.get("/setLivingRoomBrightness100", async () => {
  try {
    await living_room.setBrightness(100 /* B100 */);
...
// .wrangler/tmp/bundle-hbfznV/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-hbfznV/middleware-loader.entry.ts
